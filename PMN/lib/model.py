...
###############################################################################
#.... Prototype sampling module 
class PSM0(nn.Module):    
    def __init__(self,in_dim, out_dim):
        super(PSM0, self).__init__()
...
#.................... Correlation map genertion map
class CMGM(nn.Module):    
    def __init__(self,in_dim):
        super(CMGM, self).__init__()
...
class PMNet(nn.Module):
    def __init__(self, channel=32,ind=50):
        ...
        # funsion encoders #
        ###############################################
        self.fu_0 = PSM0(64, 64)#
        
        self.fu_1 = PSM(256, 128) #MixedFusion_Block_IMfusion
        self.pool_fu_1 = maxpool()
        
        self.fu_2 = PSM(512, 256)
        self.pool_fu_2 = maxpool()
        
        self.fu_3 = PSM(1024, 512)
        self.pool_fu_3 = maxpool()

        self.fu_4 = PSM(2048, 1024)
