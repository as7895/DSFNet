...
from lib.attention_module import IBCMF, A2SP, Sal_Head
from lib.mobilenet_V3 import mobilenetv3_large, mobilenetv3_small
...
class FusionNet(nn.Module):
    def __init__(self, channels=[16, 24, 40, 112, 160]):
        ...
        self.depth_net = mobilenetv3_large()#mobilenetv3_small()
    ...
    def load_pretrained(self):
        ...
        #获取预训练的参数
        pretrained_large_dict = torch.load('/content/drive/MyDrive/mobilenetv3-large.pth')
        #加载部分能用的参数
